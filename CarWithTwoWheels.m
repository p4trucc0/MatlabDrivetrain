classdef CarWithTwoWheels < handle
    ...
    methods
        ...
        % Constructor
        function obj = CarWithTwoWheels(n_mass, n_wheel_inertia, ...
                n_wheel_pacejka_param, n_front_mass_fraction, ...
        ...
        function [x2v, params] = get_acc(obj, x1v)
            ...
            k_p = obj.eval_slip(th1_a, obj.drivetrain.wheel_rear.R, x1_b);
            Fz_a = obj.mass*9.81*obj.front_mass_fraction;
            Fz_p = obj.mass*9.81*(1 - obj.front_mass_fraction);
            [Fx_a, ~, ~] = pacejka96(obj.wheel_pacejka_param, Fz_a/1000, 0.0, k_a, 0.0);
            [Fx_p, ~, ~] = pacejka96(obj.wheel_pacejka_param, Fz_p/1000, 0.0, k_p, 0.0);
